...
Nexion is a lightweight, open-source web browser forked from [Min](https://github.com/minbrowser/min).  
Built with Electron and modern web technologies, Nexion offers a clean interface, privacy-focused defaults, and full rebrandability for developers and creators.
